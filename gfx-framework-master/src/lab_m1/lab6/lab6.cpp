...
void Lab6::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix)
{
    ...
    glUniformMatrix4fv(viewLocation, 1, 0, glm::value_ptr(viewMatrix));
    ...
    glUniformMatrix4fv(projectionLocation, 1, 0, glm::value_ptr(projectionMatrix));
