    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
           ...
           /* forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 1)));
            ...
            glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 1);
        ...
        void RotateFirstPerson_OY(float angle)
        {
           ...
           /* forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1)));
            ...
            glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(tmp));

            tmp = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
